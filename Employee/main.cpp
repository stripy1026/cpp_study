...
int	main(void)
{
	...
	emp_list.add_manager(new Manager("J.S You", 41, "Director", 7, 12));
	emp_list.add_manager(new Manager("J.H Jung", 42, "Manager", 4, 15));
	emp_list.add_manager(new Manager("M.S Park", 43, "Conductor", 5, 13));
